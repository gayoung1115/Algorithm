...
- 주의할점
int 변수의 범위는  -2,147,483,648 ~ 2,147,483,647
나무 자르는 길이 최대 길이는 2,000,000,000 *1,000,000,000로 int변수 최대값 벗어남 -> long변수 필요

lowerbound, upperbound 개념 숙지하기 
